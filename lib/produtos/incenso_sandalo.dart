...
class Incenso_sandalo extends StatefulWidget {
  const Incenso_sandalo({super.key});

  @override
  State<Incenso_sandalo> createState() => _Incenso_sandaloState();
}

class _Incenso_sandaloState extends State<Incenso_sandalo> {
  List<String> image = [
