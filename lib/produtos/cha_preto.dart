...
class Cha_preto extends StatefulWidget {
  const Cha_preto({super.key});

  @override
  State<Cha_preto> createState() => _Cha_pretoState();
}

class _Cha_pretoState extends State<Cha_preto> {
  List<String> image = [
